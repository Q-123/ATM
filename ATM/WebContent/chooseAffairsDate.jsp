...
<body>
	...
	<nav class="navbar navbar-inverse">
  	...
  	<div class="row">
		...
		<div class="col-sm-8">
			<h3 class="text-warning" style="text-align:center"><strong>历史事务</strong></h3>
			<br><br>
			<form class="form-horizontal" role="form" action="viewAffairs.jsp" method="post">
  					...
  					<div class="form-group">
    					...
    					<tbody>
    						<tr>
    							...
    							<th>
    							<select class="form-control" name="curStatus">
